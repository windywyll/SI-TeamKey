    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_7189 = (o.vertexColor.r*1.5);
                float4 node_9606 = _Time + _TimeEditor;
                float2 node_8521_skew = o.uv0 + 0.2127+o.uv0.x*0.3713*o.uv0.y;
                float2 node_8521_rnd = 4.789*sin(489.123*(node_8521_skew));
                float node_8521 = frac(node_8521_rnd.x*node_8521_rnd.y*(1+node_8521_skew.x));
                v.vertex.xyz += (normalize((float3(0,0,0)+v.normal))*(1.0*sin(((node_7189*3.141592654)+node_9606.g))*node_7189)*node_8521);
...
////// Emissive:
                ...
                float node_6906 = 0.5;
                float3 finalColor = emissive + (_node_5708_var.rgb*node_6906);
